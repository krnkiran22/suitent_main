    ...
    const fetchBalances = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBalances.useCallback[fetchBalances]": async ()=>{
            ...
            try {
                ...
                const balancesWithMetadata = await Promise.all(allBalances.map({
                    "useBalances.useCallback[fetchBalances]": async (bal)=>{
                        try {
                            const metadata = await suiClient.getCoinMetadata({
                                coinType: bal.coinType
                            });
                ...
                balancesWithMetadata.sort({
                    "useBalances.useCallback[fetchBalances]": (a, b)=>{
                        if (a.symbol === "SUI") return -1;
                        if (b.symbol === "SUI") return 1;
                        return parseFloat(b.balance) - parseFloat(a.balance);
                    }
...
"[project]/hooks/useDeepBookQuote.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDeepBookQuote(tokenIn, tokenOut, amountIn) {
    _s();
    ...
    const fetchQuote = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDeepBookQuote.useCallback[fetchQuote]": async ()=>{
            // Reset if no amount
            ...
            const isValidPair = tokenIn === "SUI" && tokenOut === "DEEP" || tokenIn === "DEEP" && tokenOut === "SUI";
            if (!isValidPair) {
            ...
            try {
                ...
                if (!response.ok) {
                    const errorData = await response.json().catch({
                        "useDeepBookQuote.useCallback[fetchQuote]": ()=>({})
                    }["useDeepBookQuote.useCallback[fetchQuote]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDeepBookQuote.useEffect": ()=>{
            const timeoutId = setTimeout({
                "useDeepBookQuote.useEffect.timeoutId": ()=>{
                    fetchQuote();
                }
            }["useDeepBookQuote.useEffect.timeoutId"], 500); // Debounce by 500ms
            return ({
                "useDeepBookQuote.useEffect": ()=>clearTimeout(timeoutId)
            })["useDeepBookQuote.useEffect"];
        }
    }["useDeepBookQuote.useEffect"], [
        fetchQuote
...
_s(useDeepBookQuote, "o1Wewm9tMuOnwLGKxbH6xfEaGBw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/components/wallet/TransactionLimitModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TransactionLimitModal({ isOpen, onClose }) {
    ...
    const [mounted, setMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionLimitModal.useEffect": ()=>{
            setMounted(true);
            if (isOpen) {
                document.body.style.overflow = 'hidden';
            } else {
...
_s(TransactionLimitModal, "LrrVfNW3d1raFE0BNzCTILYmIfo=");
_c = TransactionLimitModal;
var _c;
__turbopack_context__.k.register(_c, "TransactionLimitModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDeepBookQuote$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useDeepBookQuote.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tokens$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/tokens.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$wallet$2f$TransactionLimitModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/wallet/TransactionLimitModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function SwapPage() {
    ...
    const { quote, loading: quoteLoading, error: quoteError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDeepBookQuote$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeepBookQuote"])(tokenIn.symbol, tokenOut.symbol, amountIn);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: quoteLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                lineNumber: 194,
                                                columnNumber: 25
                                            }, this) : quote?.estimatedAmountOut ? quote.estimatedAmountOut : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-white/40",
                                                children: "~"
                                            }, void 0, false, {
                                                fileName: "[project]/app/swap/page.tsx",
                        ...
                        amountIn && parseFloat(amountIn) > 0 && quote && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `text-sm font-semibold ${parseFloat(quote.priceImpact) > 5 ? 'text-red-400' : parseFloat(quote.priceImpact) > 2 ? 'text-yellow-400' : 'text-green-400'}`,
                                            children: [
                                                quote.priceImpact,
                                                "%"
                                            ]
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: [
                                                quote.poolId?.slice(0, 8),
                                                "...",
                                                quote.poolId?.slice(-6)
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/app/swap/page.tsx",
                                            lineNumber: 234,
                        ...
                        amountIn && parseFloat(amountIn) > 0 && quoteLoading && !quote && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$wallet$2f$TransactionLimitModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransactionLimitModal"], {
...
_s(SwapPage, "Gz/vqbFaPJ1lLh1afkCZi9WcHco=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDeepBookQuote$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeepBookQuote"]
    ];
});
_c = SwapPage;
var _c;
...
//# sourceMappingURL=_7b61cdf0._.js.map