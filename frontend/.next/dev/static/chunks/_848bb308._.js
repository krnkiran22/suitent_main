...
"[project]/lib/deepbookClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function createDeepBookClient(address, env) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$deepbookClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/deepbookClient.ts [app-client] (ecmascript)");
    ...
    const executeSwap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUniversalSwap.useCallback[executeSwap]": async (tokenIn, tokenOut, amountIn, slippage = 0.01)=>{
            ...
            try {
                ...
                const quoteData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSwapQuote"])(tokenIn, tokenOut, amountIn);
                ...
                const tx = await buildSwapTransactionFrontend(tokenIn, tokenOut, amountIn, minAmountOut, walletAddress, 'testnet');
                // Step 3: Execute transaction with browser wallet
                console.log("[useUniversalSwap] Executing with browser wallet...");
                const resultDigest = await new Promise({
                        ...
                        signAndExecute({
                            ...
                            onSuccess: {
                                "useUniversalSwap.useCallback[executeSwap]": (result)=>{
                                    ...
                                    console.log("[useUniversalSwap] 🔍 View on Suiscan: https://testnet.suiscan.xyz/tx/" + result.digest);
...
_s(useUniversalSwap, "4VIqsdB9bB6zRckDC1VIi1Bea8Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mysten$2f$dapp$2d$kit$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentAccount"],
...
async function buildSwapTransactionFrontend(tokenIn, tokenOut, amountIn, minAmountOut, walletAddress, env = 'testnet') {
    console.log(`[buildSwapTransactionFrontend] Building ${tokenIn} -> ${tokenOut} swap with DeepBook SDK`);
    // Create DeepBook client (per docs)
    const deepbookClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$deepbookClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDeepBookClient"])(walletAddress, env);
...
_s(SwapCard, "IkEH8TsYXAzwI7K5/mpBSJgf8UA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mysten$2f$dapp$2d$kit$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentAccount"],
...
//# sourceMappingURL=_848bb308._.js.map