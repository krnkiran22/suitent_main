module.exports = [
"[project]/node_modules/@turnkey/core/dist/__wallet__/stamper.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class CrossPlatformWalletStamper {
     ...
     */ defaultInterface() {
        ...
        if (initializedInterfaces.includes(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Ethereum)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Ethereum;
        }
        if (initializedInterfaces.includes(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Solana)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Solana;
        }
        if (initializedInterfaces.includes(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect;
        }
...
class WalletStamper {
     ...
     */ async stamp(payload, provider) {
        ...
        let publicKey;
        try {
            signature = await this.wallet.sign(payload, provider, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignMessage);
        } catch (error) {
            throw new Error(`Failed to sign the message: ${error}`);
        }
        const scheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSignatureSchemeFromProvider"])(provider);
        try {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isEthereumProvider"])(provider)) {
                const { recoverPublicKey, hashMessage } = await __turbopack_context__.A("[project]/node_modules/viem/_esm/index.js [app-ssr] (ecmascript, async loader)");
                const { compressRawPublicKey, toDerSignature } = await __turbopack_context__.A("[project]/node_modules/@turnkey/crypto/dist/index.mjs [app-ssr] (ecmascript, async loader)");
                const rawPublicKey = await recoverPublicKey({
                    hash: hashMessage(payload),
                    signature: signature
                });
                const publicKeyHex = rawPublicKey.startsWith("0x") ? rawPublicKey.slice(2) : rawPublicKey;
                const publicKeyBytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayFromHexString"])(publicKeyHex);
                const publicKeyBytesCompressed = compressRawPublicKey(publicKeyBytes);
                publicKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(publicKeyBytesCompressed);
                signature = toDerSignature(signature.replace("0x", ""));
            } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSolanaProvider"])(provider)) {
        ...
        return {
            ...
            stampHeaderValue: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$base64$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stringToBase64urlString"])(JSON.stringify({
                publicKey,
                scheme,
                signature
            }))
...
"[project]/node_modules/@turnkey/core/dist/__wallet__/connector.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "CrossPlatformWalletConnector",
    ()=>CrossPlatformWalletConnector
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__types__/enums.mjs [app-ssr] (ecmascript)");
;
class CrossPlatformWalletConnector {
     ...
     */ async switchChain(provider, chainOrId) {
        if (provider.chainInfo.namespace !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum) {
...
"[project]/node_modules/@turnkey/core/dist/__wallet__/web/native/ethereum.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class BaseEthereumWallet {
    constructor(){
        this.interfaceType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Ethereum;
        /**
         ...
         */ this.getPublicKey = async (provider)=>{
            ...
            const signature = await this.sign(message, provider, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignMessage);
            ...
            const handler = (ev)=>{
                ...
                const promise = (async ()=>{
                    ...
                    try {
                        ...
                        const accounts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["withTimeoutFallback"])(provider.request?.({
                            method: "eth_accounts"
                        }) ?? Promise.resolve([]), []);
                        ...
                        if (connectedAddresses.length > 0) {
                            chainId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["withTimeoutFallback"])(provider.request({
                                method: "eth_chainId"
                            }), "0x1");
                        }
                    } catch  {
                    ...
                    discovered.push({
                        interfaceType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Ethereum,
                        chainInfo: {
                            namespace: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum,
                            chainId
                        },
     ...
     */ async switchChain(provider, chainOrId) {
        ...
        try {
            ...
            if (typeof chainOrId === "string") {
                throw new Error(`Chain ${chainId} not recognized. ` + `If you want to add it, call switchChain with a SwitchableChain object.`);
            }
 ...
 */ class EthereumWallet extends BaseEthereumWallet {
    constructor(){
         ...
         */ this.sign = async (payload, provider, intent)=>{
            ...
            switch(intent){
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignMessage:
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignAndSendTransaction:
                    {
                        const tx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$transaction$2f$transaction$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transaction"].from(payload);
                        const base = {
                            from: account,
                            to: tx.to?.toString(),
                            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.value),
                            gas: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.gasLimit),
                            nonce: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.nonce),
                            chainId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.chainId),
                        ...
                        if (txType === undefined || txType === 0 || txType === 1) {
                            ...
                            txParams = {
                                ...base,
                                gasPrice: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.gasPrice)
                            };
                        } else {
                            ...
                            txParams = {
                                ...base,
                                maxFeePerGas: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.maxFeePerGas),
                                maxPriorityFeePerGas: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(tx.maxPriorityFeePerGas)
                            };
                        }
                        return await selectedProvider.request({
 ...
 */ const getCompressedPublicKey = async (signature, message)=>{
    const secp256k1PublicKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$signature$2f$recoverPublicKey$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recoverPublicKey"])({
    ...
    const publicKeyHex = secp256k1PublicKey.startsWith("0x") ? secp256k1PublicKey.slice(2) : secp256k1PublicKey;
    const publicKeyBytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayFromHexString"])(publicKeyHex);
    const publicKeyBytesCompressed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$crypto$2f$dist$2f$crypto$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressRawPublicKey"])(publicKeyBytes);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(publicKeyBytesCompressed);
};
/**
...
"[project]/node_modules/@turnkey/core/dist/__wallet__/web/native/solana.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class BaseSolanaWallet {
    constructor(){
        this.interfaceType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Solana;
        /**
         ...
         */ this.getPublicKey = async (provider)=>{
            ...
            const rawBytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$bs58$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bs58"].decode(account.address);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(rawBytes);
        };
        /**
         ...
         */ this.getProviders = async ()=>{
            ...
            const providers = walletsApi.get().filter((w)=>w.chains.some((c)=>c.startsWith("solana:")));
            await Promise.all(providers.map(async (wallet)=>{
                ...
                const connectedAddresses = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["withTimeoutFallback"])((async ()=>{
                    try {
                ...
                discovered.push({
                    interfaceType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Solana,
                    chainInfo: {
                        namespace: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Solana
                    },
                    // Some wallet providers include leading whitespace in their icon URLs.
                    // Next.js 15+ and other frameworks are strict about URL formatting,
                    // so we trim
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignMessage:
                    {
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(results[0].signature);
                    }
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignTransaction:
                    {
                        const signFeature = wallet.features["solana:signTransaction"];
                        if (!signFeature) throw new Error("Provider does not support solana:signTransaction");
                        const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayFromHexString"])(payload);
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(results[0].signedTransaction);
                    }
                default:
                    throw new Error(`Unsupported sign intent: ${intent}`);
            }
 ...
 */ const asSolana = (provider)=>{
    if (provider.provider && "features" in provider.provider && "solana:signMessage" in provider.provider.features) {
...
"[project]/node_modules/@turnkey/core/dist/__wallet__/wallet-connect/client.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class WalletConnectClient {
     ...
     */ async init(opts) {
        this.client = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].init({
        ...
        try {
            ...
            const disconnectPromises = pairings.map(async (pairing)=>{
                try {
                    ...
                    if (err.message?.includes("Expired") || err.message?.includes("Not found") || err.message?.includes("No matching key")) {
...
"[project]/node_modules/@turnkey/core/dist/__wallet__/wallet-connect/base.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class WalletConnectWallet {
     ...
     */ constructor(client, ensureReady, namespaces){
        ...
        this.interfaceType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect;
        ...
        this.client.onSessionEvent(({ event })=>{
            if (event?.name === "chainChanged" || event?.name === "accountsChanged") {
                const chainId = typeof event.data?.chainId === "string" ? event.data.chainId : undefined;
                this.notifyChange({
                    type: "chainChanged",
                    chainId
                });
     ...
     */ async init() {
        ...
        try {
            if (this.ethereumNamespaces.length === 0 && this.solanaNamespaces.length === 0) {
     ...
     */ async sign(payload, provider, intent) {
        ...
        if (provider.chainInfo.namespace === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum) {
            ...
            switch(intent){
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignAndSendTransaction:
                    ...
                    return await this.client.request(this.ethChain, "eth_sendTransaction", [
                        txParams
                    ]);
                default:
        ...
        if (provider.chainInfo.namespace === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Solana) {
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignMessage:
                    {
                        ...
                        const msgB58 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$bs58$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bs58"].encode(msgBytes);
                        const { signature: sigB58 } = await this.client.request(this.solChain, "solana_signMessage", {
                            pubkey: address,
                            message: msgB58
                        });
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$bs58$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bs58"].decode(sigB58));
                    }
                case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignIntent"].SignTransaction:
                    {
                        const txBytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayFromHexString"])(payload);
                        const txBase64 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$base64$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stringToBase64urlString"])(String.fromCharCode(...txBytes));
     ...
     */ async getPublicKey(provider) {
        ...
        if (provider.chainInfo.namespace === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum) {
            ...
            const rawPublicKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$signature$2f$recoverPublicKey$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recoverPublicKey"])({
                hash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$signature$2f$hashMessage$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hashMessage"])("GET_PUBLIC_KEY"),
                signature: sig
            });
            const publicKeyHex = rawPublicKey.startsWith("0x") ? rawPublicKey.slice(2) : rawPublicKey;
            const publicKeyBytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayFromHexString"])(publicKeyHex);
        ...
        if (provider.chainInfo.namespace === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Solana) {
            ...
            const publicKeyBytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$bs58$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bs58"].decode(address);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$encoding$2f$dist$2f$hex$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])(publicKeyBytes);
        }
     ...
     */ async buildEthProvider(session, info) {
        ...
        return {
            interfaceType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect,
            chainInfo: {
                namespace: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum,
                chainId: chainidHex
            },
 ...
 */ function hasConnectedAccounts(session) {
    return !!session && Object.values(session.namespaces).some((ns)=>ns.accounts?.length > 0);
}
/**
...
"[project]/node_modules/@turnkey/core/dist/__wallet__/web/manager.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$stamper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__wallet__/stamper.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$connector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__wallet__/connector.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$web$2f$native$2f$ethereum$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__wallet__/web/native/ethereum.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$web$2f$native$2f$solana$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__wallet__/web/native/solana.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__types__/enums.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$wallet$2d$connect$2f$client$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__wallet__/wallet-connect/client.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$wallet$2d$connect$2f$base$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/__wallet__/wallet-connect/base.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turnkey/core/dist/utils.mjs [app-ssr] (ecmascript)");
;
;
;
...
class WebWalletManager {
     ...
     */ constructor(cfg){
        ...
        if (enableNativeEvm) {
            this.wallets[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Ethereum] = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$web$2f$native$2f$ethereum$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EthereumWallet"]();
            this.addChainInterface(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Ethereum);
        }
        // set up native Solana wallet support
        if (enableNativeSol) {
            this.wallets[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Solana] = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$web$2f$native$2f$solana$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SolanaWallet"]();
            this.addChainInterface(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Solana, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].Solana);
        }
        // if WalletConnect is configured, set it up
        if (cfg.walletConnect && enableWalletConnect) {
            this.wcClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$wallet$2d$connect$2f$client$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletConnectClient"]();
            const wcUnified = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$wallet$2d$connect$2f$base$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletConnectWallet"](this.wcClient, ()=>this.ensureWalletConnectReady(), {
                ethereumNamespaces,
                solanaNamespaces
            });
            this.wallets[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect] = wcUnified;
            // add async init step to the initializer queue
            this.initializers.push(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["withTimeout"])(wcUnified.init(), 15000, "WalletConnect wallet").catch((err)=>{
                    ...
                    this.removeWalletInterface(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect);
                }));
            // register WalletConnect as a wallet interface for each enabled chain
            if (enableWalletConnectEvm) this.addChainInterface(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Ethereum, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect);
            if (enableWalletConnectSol) this.addChainInterface(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Chain"].Solana, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$types_$5f2f$enums$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletInterfaceType"].WalletConnect);
        }
        if (cfg.features?.auth) {
            this.stamper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$stamper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CrossPlatformWalletStamper"](this.wallets);
        }
        if (cfg.features?.connecting) {
            this.connector = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$connector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CrossPlatformWalletConnector"](this.wallets);
        }
    }
    /**
     ...
     */ async getProviders(chain) {
        if (chain) {
            ...
            if (!interfaceTypes || interfaceTypes.length === 0) throw new Error(`No wallet supports chain: ${chain}`);
            const walletsToQuery = interfaceTypes.map((iface)=>this.wallets[iface]).filter(Boolean);
            ...
            return providersArrays.flat().filter((p)=>p.chainInfo.namespace === chain);
        }
...
"[project]/node_modules/ox/_esm/core/Secp256k1.js [app-ssr] (ecmascript) <export * as Secp256k1>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "Secp256k1",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Secp256k1$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
...
"[project]/node_modules/@walletconnect/utils/node_modules/@scure/base/lib/esm/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_68e40967._.js.map