...
"[project]/node_modules/@turnkey/core/dist/__wallet__/mobile/manager.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MobileWalletManager {
     ...
     */ constructor(cfg){
        ...
        if (cfg.walletConnect && enableWalletConnect) {
            ...
            const wcUnified = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turnkey$2f$core$2f$dist$2f$_$5f$wallet_$5f2f$wallet$2d$connect$2f$base$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletConnectWallet"](this.wcClient, undefined, {
                ethereumNamespaces,
                solanaNamespaces
            });
     ...
     */ async getProviders(chain) {
        if (chain) {
            ...
            const walletsToQuery = interfaceType.map((iface)=>this.wallets[iface]).filter(Boolean);
...
//# sourceMappingURL=node_modules_0a7ddd6a._.js.map