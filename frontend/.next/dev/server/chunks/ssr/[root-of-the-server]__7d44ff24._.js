...
"[project]/lib/deepbookClient.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$deepbookClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/deepbookClient.ts [app-ssr] (ecmascript)");
...
function useUniversalSwap() {
    ...
    const executeSwap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (tokenIn, tokenOut, amountIn, slippage = 0.01)=>{
        ...
        try {
            ...
            const quoteData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSwapQuote"])(tokenIn, tokenOut, amountIn);
            ...
            const resultDigest = await new Promise((resolve, reject)=>{
                signAndExecute({
                    transaction: tx
                }, {
                    onSuccess: (result)=>{
...
async function buildSwapTransactionFrontend(tokenIn, tokenOut, amountIn, minAmountOut, walletAddress, env = 'testnet') {
    ...
    const deepbookClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$deepbookClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDeepBookClient"])(walletAddress, env);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d44ff24._.js.map